        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit Kegiatan CSR Non List</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="" action="<?= base_url(); ?>admin/kegiatan_update_non" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                    ...
                                    <div class="card-body bootstrap-select-1">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mt-3">
                                                ...
                                                <input type="text" class="form-control" name="nominal" value="<?= $d['nominal']; ?>">
                                            </div>
                                            <div class="col-md-4 mt-3">
                                            ...
                                            <div class="col-md-2 mt-3">
                                                ...
                                                <div class="card m-b-30">
                                                    <input type="date" class="form-control" name="tgl_pelaksanaan" value="<?= date('Y-m-d', strtotime($d['waktu'])); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12 mt-4">
                                                <div class="form-group">
                                                    <div>
                                                        ...
                                                        <a href="<?= base_url(); ?>admin/kegiatan_csr_non" class="btn btn-secondary waves-effect m-l-5">
                                                            Cancel
                                                        </a>
                                                    </div>
                                                </div>
